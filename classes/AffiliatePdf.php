...
class AffiliatePdf
{
     ...
     * @param string $qrcode   url
     */
    public function __construct($store_name, $store_logo, $qrcode)
    {
    ...
    public function createPDF($html, $output = 'I')
    {
        ...
        */
        $pdf->Output('ecjia_merchant_affiliate.pdf', $output);
    }
...
EOL;
    ...
    public function formatHtml()
    {
        ...
        <div style="border: 2px solid #eee; float: left; background-color: #379ED8; text-align: center;">
            ...
            <div style="margin-top: 20px;"><img src="{$this->qrcode}" style="width: 530px;height: 530px;"></div>
            <div style="color: #fff;font-size: 12pt; margin-top: 20px;">扫描二维码与店铺绑定关系</div>
        </div>
EOL;
        return $html;
    }
