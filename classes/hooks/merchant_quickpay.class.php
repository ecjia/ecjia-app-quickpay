...
class quickpay_merchant_hook {
	...
	public static function quickpay_merchant_menu_api($menus) {
	    $menu = ecjia_merchant::make_admin_menu('05_merchant_qrcode', __('收款二维码', 'quickpay'), RC_Uri::url('quickpay/mh_qrcode/init'), 4)->add_purview('quickpay_collectmoney_qrcode')->add_icon('fa-qrcode');
