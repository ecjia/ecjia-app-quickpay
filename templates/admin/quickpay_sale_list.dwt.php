...
<div>
	<h3 class="heading">
		...
		<!-- {if $action_link} -->
		<a class="btn plus_or_reply data-pjax" href="{$action_link.href}&start_date={$filter.start_date}&end_date={$filter.end_date}"><i class="fontello-icon-download"></i>{$action_link.text}</a>
		<!-- {/if} -->
	</h3>
</div>
