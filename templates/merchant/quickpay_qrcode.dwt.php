        ...
        <div class="panel panel-body">
            <div class="qrcode-content">
                <div class="left-side">
                    <div class="store-logo"><img src="{$merchant_info.shop_logo}"></div>
                    <div class="store-name">{$merchant_info.merchants_name}</div>
                    <div class="qrcode"><img src="{$merchant_info.affiliate_qrcode}"></div>
                ...
                <div class="right-side">
                    ...
                    <div class="right-content">
                        <p>{t domain="quickpay"}此二维码用于商家推广使用，商家可以将带有店铺ID的二维码，应用到制作广告、印刷海报等需要用的地方，还可通过朋友及朋友圈转发，让更多用户扫描该二维码后，快速与商家店铺绑定关系，帮助让会员的归属店铺划分更清楚。{/t}</p>
                        <p>{t domain="quickpay"}打印尺寸：A4纸尺寸{/t}</p>
                        <p>{t domain="quickpay"}使用说明：先将二维码下载，用A4纸打印后裁切出来，印刷成海报或广告，可张贴在店铺内服务台等处，方便用户扫码。{/t}</p>
                    </div>
                    <div class="right-handle">
                        <a class="btn btn-primary" href="{$refresh_url}&type=affiliate" data-toggle="ajaxremove" data-msg='{t domain="quickpay"}您确定要刷新该二维码吗？{/t}'>{t domain="quickpay"}刷新二维码{/t}</a>
