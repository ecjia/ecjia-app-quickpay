			...
			<div class="panel-body">
				<section id="unseen">
					<ul class="nav nav-tabs">
						...
						<!-- {if $smarty.get.query_by_year} -->
						<a class="data-pjax" href='{url path="quickpay/mh_sale_general/init" args="&query_by_year=1{if $smarty.get.year_beginYear}&year_beginYear={$smarty.get.year_beginYear}{/if}{if $smarty.get.year_endYear}&year_endYear={$smarty.get.year_endYear}{/if}"}'>{t}{lang key='orders::order.order_status'}{/t}</a>
						<!-- {else if $smarty.get.query_by_month} -->
						...
						<!-- {else} -->
						<a class="data-pjax" href='{url path="quickpay/mh_sale_general/init"}'>{t}{lang key='orders::statistic.order_status'}{/t}</a>
						<!-- {/if} -->
						<li class="{if $page eq 'sales_trends'}active{/if}">
						<!-- {if $smarty.get.query_by_year} -->
						<a class="data-pjax" href='{url path="quickpay/mh_sale_general/sales_trends" args="&query_by_year=1{if $smarty.get.year_beginYear}&year_beginYear={$smarty.get.year_beginYear}{/if}{if $smarty.get.year_endYear}&year_endYear={$smarty.get.year_endYear}{/if}"}'>{t}{lang key='orders::statistic.turnover_status'}{/t}</a>
						<!-- {else if $smarty.get.query_by_month} -->
						...
						<!-- {else} -->
						<a class="data-pjax" href='{url path="quickpay/mh_sale_general/sales_trends"}'>{t}{lang key='orders::statistic.turnover_status'}{/t}</a>
						<!-- {/if} -->
						</li>
					</ul>
